...
var generatePassword = function(options) {
    ...
    var animals = ["Alligator", "bull", "cow", "Alpaca", "Antelope", "doe", "Ape", "Armadillo", "Baboon", "Badger", "boar", "sow", "Bat", "Bear", "Beaver", "Bee", "Bird", "hen", "Buffalo", "Boar", "Butterfly", "Camel", "Cat", "queen", "Cattle", "Cheetah", "Chicken", "rooster", "Clam", "Cockroach", "Codfish", "Coyote", "dog", "Crow", "Deer", "stag", "Dinosaur", "Dog", "Dolphin", "Donkey", "Dove", "Duck", "duck", "Eagle", "Eel", "Elephant", "Elk", "Emu", "Falcon", "terzel", "falcon", "Ferret", "Fish", "Finch", "Flamingo", "Fly", "Fox", "tod", "Frog", "Gerbil", "Giraffe", "Gnat", "Goat", "billy", "nanny", "Goose", "goose", "Gorilla", "Grasshopper", "Guinea", "pig", "Gull", "Hamster", "Hare", "Hawk", "Hedgehog", "Hippo", "Hornet", "Hog", "Horse", "stud", "Hound", "Human", "man", "woman", "Hummingbird", "Hyena", "Jellyfish", "Kangaroo", "Koala", "Lark", "Leopard", "leopard", "leopardess", "lion", "lioness", "Llama", "Locust", "Louse", "Magpie", "Mallard", "Mole", "Monkey", "Moose", "Mosquito", "Mouse", "Mule"
        "Nightingale", "Opossum", "Ostrich", "Otter", "Owl", "Ox", "Oyster", "Panda", "Parrot", "Peafowl", "peacock", "Penguin", "Pheasant", "Pig", "Pigeon", "Platypus", "Porpoise", "Quail", "Rabbit", "Raccoon", "Rat", "Raven", "Reindeer", "Rhinoceros", "Seal", "Seastar", "Urchin", "Shark", "Sheep", "ram", "Skunk", "Snake", "sparrow", "Spider", "Squid", "Squirrel", "Swallow", "Swan", "Termite", "Tiger", "tigress", "Toad", "Trout", "Turkey", "Turtle", "Walrus", "Wasp", "Weasel", "Whale", "Wolf", "Wombat", "Woodpecker", "Yak", "Zebra", "stallion", "mare"
    ]
    var defaultOptions = {
        asdf: "true"
    }
